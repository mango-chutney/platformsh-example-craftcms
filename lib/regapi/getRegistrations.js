...
var _default = ({
  ...
  const params = typeof args === 'object' ? (0, _paramify.default)(args) : args;
  return fetch(typeof args === 'object' ? `${baseURL}/Registrations?${params}` : `${baseURL}/Registrations/${params}`, {
    method: 'GET',
