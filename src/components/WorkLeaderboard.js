    ...
    Papa.parse(fileURL, {
      ...
      complete: results => {
        ...
        resolve(
          results.data
            .slice(7)
            .filter(business => business[4] === 'Business')
...
class WorkLeaderboard extends Component {
  state = {
    items: [],
  ...
  render() {
    const { items, limit, loading } = this.state;
          ...
          <div>
            <div className="row text-center">
              <div className="columns">
                <h2>Top Businesses Leaderboard</h2>
                <h4 className="subheading text-gray">
                  See the top 100 businesses and their amazing efforts so far
                </h4>
              </div>
            </div>
            <div className="row">
...
export default WorkLeaderboard;
